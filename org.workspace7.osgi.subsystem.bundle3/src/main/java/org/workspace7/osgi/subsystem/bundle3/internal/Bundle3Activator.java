...
public class Bundle3Activator implements BundleActivator {

	public void start(BundleContext bundleContext) throws Exception {

		_log.trace("Bundle3Activator.start()");
	...
	private Logger _log = LoggerFactory.getLogger(Bundle3Activator.class);
	...
	private class HelperServiceTracker implements
		...
		public Helper addingService(ServiceReference<Helper> reference) {
			...
			_log.debug("Bundle3Activator.HelperServiceTracker.addingService()");
			...
			if (_helper != null && _httpService != null) {
				...
				try {
					...
					_log.info("Registering servlet /bundle3");

					_httpService.registerServlet("/bundle3",
							new BundleServlet3(_helper), null, null);
